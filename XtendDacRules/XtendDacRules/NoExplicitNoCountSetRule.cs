...
namespace Xtend.Dac.Rules
{
    [XtendExportCodeAnalysisRuleAttribute(
        NoExplicitNoCountSetRule.RuleId,
        RuleConstants.NoExplicitNoCountSet_RuleName,              // ID used to look up the display name inside the resources file
        RuleConstants.NoExplicitNoCountSet_ProblemDescription,    // ID used to look up the description inside the resources file
        Category = RuleConstants.CategoryPerformance,            // Rule category (e.g. "Design", "Naming")
        RuleScope = SqlRuleScope.Element)]                  // This rule targets specific elements rather than the whole model

    public sealed class NoExplicitNoCountSetRule : XtendSqlProcedureAnalysisRule
    {
        /// <summary>
        /// This rule= will be grouped by "Xtend.Dac.Rules.Performance", with the rule
        /// shown as "XR0004: All procedures must set nocount"
        /// </summary>
        public const string RuleId = "Xtend.Rules.Data.XR0004";

        public NoExplicitNoCountSetRule()
        {
