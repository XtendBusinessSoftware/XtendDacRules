...
namespace Xtend.Dac.Rules
{
    [XtendExportCodeAnalysisRuleAttribute(
        MissingMandatoryParameterRule.RuleId,
        RuleConstants.MissingMandatoryParameter_RuleName,              // ID used to look up the display name inside the resources file
        RuleConstants.MissingMandatoryParameter_ProblemDescription,    // ID used to look up the description inside the resources file
    ...
    public sealed class MissingMandatoryParameterRule : SqlCodeAnalysisRule
    {
        ...
        /// shown as "XR0007: All mandatory parameters must be filled in"
        /// </summary>
        public const string RuleId = "Xtend.Rules.Data.XR0007";

        public MissingMandatoryParameterRule()
        {
