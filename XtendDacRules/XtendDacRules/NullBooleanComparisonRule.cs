...
namespace Xtend.Dac.Rules
{
    [XtendExportCodeAnalysisRuleAttribute(
        NullBooleanComparisonRule.RuleId,
        RuleConstants.NullBooleanComparison_RuleName,              // ID used to look up the display name inside the resources file
    ...
    public sealed class NullBooleanComparisonRule : SqlCodeAnalysisRule
    {
        ...
        /// shown as "XR0012: Invalid null boolean expression"
        /// </summary>
        public const string RuleId = "Xtend.Rules.Data.XR0012";

        public NullBooleanComparisonRule()
        {
