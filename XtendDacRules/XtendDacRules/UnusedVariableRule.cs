...
namespace Xtend.Dac.Rules
{
    [XtendExportCodeAnalysisRuleAttribute(
        UnusedVariableRule.RuleId,
        RuleConstants.UnusedVariable_RuleName,              // ID used to look up the display name inside the resources file
        RuleConstants.UnusedVariable_ProblemDescription,    // ID used to look up the description inside the resources file
        Category = RuleConstants.CategoryDesign,            // Rule category (e.g. "Design", "Naming")
        RuleScope = SqlRuleScope.Element)]                  // This rule targets specific elements rather than the whole model

    public sealed class UnusedVariableRule : XtendSqlProcedureAnalysisRule
    {
        /// <summary>
        /// This rule= will be grouped by "Xtend.Dac.Rules.Naming", with the rule
        /// shown as "XR0005: No unused variables may exist"
        /// </summary>
        public const string RuleId = "Xtend.Rules.Data.XR0005";
